...
export const projects: Project[] = [
  {
    ...
    links: {
      ...
      demo: 'https://example.github.io/Profile/projects/aurora-ops/'
    },
    gallery: [
  ...
  },
  {
    ...
    links: {
      ...
      demo: 'https://example.github.io/Profile/projects/lattice-notes/'
    },
  ...
  },
  {
    ...
    techStack: ['Next.js', 'TypeScript', 'WebGL', 'Framer Motion', 'Edge Runtime'],
    links: {
      github: 'https://github.com/example/vector-field',
      demo: 'https://example.github.io/Profile/projects/vector-field/'
    }
  }
];
